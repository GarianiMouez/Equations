//////   in this scriptes we will devlope function that returns all equations value
...
const AllValues = (data) => {
  ...
  methania.Disponibilite_d_installation_mois =
    calc.AvailabilityOfMotorsPerMonth(
      Facteur_disponibilite_installation,
      tE2,
      31
    );
  ...
  methania.Energie_produite_totale =
    methania.Energie_produite_par_moteur1 +
    methania.Energie_produite_par_moteur2;
